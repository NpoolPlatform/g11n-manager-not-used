...
func (alc *AppLangCreate) defaults() error {
	if _, ok := alc.mutation.CreatedAt(); !ok {
		if applang.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized applang.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := applang.DefaultCreatedAt()
		alc.mutation.SetCreatedAt(v)
	}
	if _, ok := alc.mutation.UpdatedAt(); !ok {
		if applang.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized applang.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := applang.DefaultUpdatedAt()
		alc.mutation.SetUpdatedAt(v)
	}
	if _, ok := alc.mutation.DeletedAt(); !ok {
		if applang.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized applang.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := applang.DefaultDeletedAt()
		alc.mutation.SetDeletedAt(v)
	}
	if _, ok := alc.mutation.AppID(); !ok {
		if applang.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized applang.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := applang.DefaultAppID()
		alc.mutation.SetAppID(v)
	}
	if _, ok := alc.mutation.LangID(); !ok {
		if applang.DefaultLangID == nil {
			return fmt.Errorf("ent: uninitialized applang.DefaultLangID (forgotten import ent/runtime?)")
		}
	...
	if _, ok := alc.mutation.ID(); !ok {
		if applang.DefaultID == nil {
			return fmt.Errorf("ent: uninitialized applang.DefaultID (forgotten import ent/runtime?)")
		}
		v := applang.DefaultID()
...
func (alc *AppLangCreate) check() error {
	if _, ok := alc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "AppLang.created_at"`)}
	}
	if _, ok := alc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "AppLang.updated_at"`)}
	}
	if _, ok := alc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "AppLang.deleted_at"`)}
	}
	return nil
}
