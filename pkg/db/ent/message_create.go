...
func (mc *MessageCreate) defaults() error {
	...
	if _, ok := mc.mutation.DeletedAt(); !ok {
		if message.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized message.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
	...
	if _, ok := mc.mutation.LangID(); !ok {
		if message.DefaultLangID == nil {
			return fmt.Errorf("ent: uninitialized message.DefaultLangID (forgotten import ent/runtime?)")
		}
