...
[![Test](https://github.com/NpoolPlatform/g11n-manager/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/g11n-manager/actions/workflows/main.yml)
...
* make g11n-manager ```单独编译服务```
* make g11n-manager-image ```单独生成服务镜像```
