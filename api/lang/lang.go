...
import (
	...
	converter "github.com/NpoolPlatform/g11n-manager/pkg/converter/lang"
	crud "github.com/NpoolPlatform/g11n-manager/pkg/crud/lang"
...
func (s *Server) CreateLang(ctx context.Context, in *npool.CreateLangRequest) (*npool.CreateLangResponse, error) {
	...
	span = commontracer.TraceInvoker(span, "lang", "crud", "Create")
...
func (s *Server) CreateLangs(ctx context.Context, in *npool.CreateLangsRequest) (*npool.CreateLangsResponse, error) {
	...
	span = commontracer.TraceInvoker(span, "lang", "crud", "CreateBulk")

	rows, err := crud.CreateBulk(ctx, in.GetInfos())
	if err != nil {
		logger.Sugar().Errorf("fail create langs: %v", err)
...
func (s *Server) GetLang(ctx context.Context, in *npool.GetLangRequest) (*npool.GetLangResponse, error) {
	...
	span = commontracer.TraceInvoker(span, "lang", "crud", "Row")

	info, err := crud.Row(ctx, id)
	if err != nil {
		logger.Sugar().Errorf("fail get lang: %v", err)
...
func (s *Server) GetLangOnly(ctx context.Context, in *npool.GetLangOnlyRequest) (*npool.GetLangOnlyResponse, error) {
	...
	span = commontracer.TraceInvoker(span, "lang", "crud", "RowOnly")

	info, err := crud.RowOnly(ctx, in.GetConds())
	if err != nil {
		logger.Sugar().Errorf("fail get langs: %v", err)
...
func (s *Server) GetLangs(ctx context.Context, in *npool.GetLangsRequest) (*npool.GetLangsResponse, error) {
	...
	span = commontracer.TraceInvoker(span, "lang", "crud", "Rows")
...
func (s *Server) ExistLang(ctx context.Context, in *npool.ExistLangRequest) (*npool.ExistLangResponse, error) {
	...
	span = commontracer.TraceInvoker(span, "lang", "crud", "Exist")

	exist, err := crud.Exist(ctx, id)
	if err != nil {
		logger.Sugar().Errorf("fail check lang: %v", err)
...
func (s *Server) ExistLangConds(ctx context.Context,
	...
	span = tracer.TraceConds(span, in.GetConds())
	span = commontracer.TraceInvoker(span, "lang", "crud", "ExistConds")
...
func (s *Server) CountLangs(ctx context.Context, in *npool.CountLangsRequest) (*npool.CountLangsResponse, error) {
	...
	span = tracer.TraceConds(span, in.GetConds())
	span = commontracer.TraceInvoker(span, "lang", "crud", "Count")

	total, err := crud.Count(ctx, in.GetConds())
	if err != nil {
		logger.Sugar().Errorf("fail count langs: %v", err)
